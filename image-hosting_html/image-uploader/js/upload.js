...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const browseFileButton = document.querySelector('.upload__button-btn');
    ...
    const handleAndStoreFiles = (files) => {
        ...
        for (const file of files) {
            ...
            reader.onload = (event) => {
                ...
                if (storedFiles.length === (JSON.parse(localStorage.getItem('uploadedImages')) || []).length) {
                    updateTabStyles();
                }
            };
        ...
        if (filesAdded) {
            ...
            alert("Files selected successfully! Go to the 'Images' tab or click 'Browse your file' to view them.");
        }
    };
